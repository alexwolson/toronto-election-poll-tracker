...
| 04 | [Place opponent-history signals once, at race level](issues/04-place-opponent-history-signals-once-at-race-level.md) | data/feed + frontend | 02 | resolved |
| 05 | [Explain incumbent CDI components with ward facts](issues/05-explain-incumbent-cdi-components-with-ward-facts.md) | data + frontend | — | resolved |

**Frontier: empty — all sub-tickets resolved. A is complete.**
